...
class LasWriterTestCase(unittest.TestCase):
    ...
    def test_x(self):
        ...
        self.assertEqual(list(x), list(x2))
    ...
    def test_y(self):
        ...
        self.assertEqual(list(y), list(y2))
...
class LasHeaderWriterTestCase(unittest.TestCase):
    ...
    def test_min_max_update(self):
        ...
        self.assertEqual(file_max, [self.FileObject.x[0], self.FileObject.y[0], self.FileObject.z[0]])
    ...
    def test_vlr_parsing_api(self):
        ...
        VLRFile = File.File(self.tempfile2, mode = "rw")
        self.assertEqual(pb, VLRFile.header.vlrs[0].parsed_body)
        VLRFile.close()
...
class LasWriteModeTestCase(unittest.TestCase):
    ...
    def test_using_barebones_header(self):
        ...
        self.assertEqual(File2.header.version, "1.2")
        ...
        File2.Y = Y
        File2.Z = Z
        self.assertEqual(list(X), list(File2.get_x()))
        self.assertEqual(list(Y), list(File2.get_y()))
        self.assertEqual(list(Z), list(File2.get_z()))
        File2.close(ignore_header_changes = True)
    ...
    def test_format_change_and_extra_bytes(self):
        ...
        self.assertIn(b"Test", bytes(File2.get_extra_bytes()[14]))
        File2.close(ignore_header_changes = True)
    def tearDown(self):
        self.File1.close()
        os.remove(self.tempfile)
...
class LasV_14TestCase(unittest.TestCase):
    ...
    def test_file_signature_correct(self):
        """Testing that file signatures are read correctly"""
        self.assertEqual(self.File1.header.get_filesignature(), 'LASF')
...
class LasLazReaderTestCase(unittest.TestCase):
    ...
    def test_read_data(self):
        ...
        self.assertEqual(len(File1.X), 1065)
        File1.close()
